...
class RobotEnv():
  def __init__(self,
    ...
    self.robot = robot.Robot(pybullet_api=self.p,urdf_path=self.urdf_dir, start_pos=[0, self.p.getAABB(self.table_id)[0][1], 0])
    self.robot1 = robot.Robot(pybullet_api=self.p,urdf_path=self.urdf_dir, start_pos=[0, self.p.getAABB(self.table_id)[1][1], 0])
  ...
  def init_obj(self):
    ...
    # microwave
    # self.obj_position = [0.44+0.038, -0.07+0.083, table_z+0.14]
    # self.obj_position[0] = 0.43
    # self.obj_scaling = 0.3
 
    # laptop
    self.obj_position = [0.43, -0.07+0.083, table_z+0.03]
    self.obj_scaling = 0.4
    ...
    # self.obj_id = self.p.loadURDF( os.path.join(self.urdf_dir, "obj_libs/microwaves/7263/mobility.urdf"),basePosition=self.obj_position,baseOrientation=self.obj_orientation,globalScaling=self.obj_scaling,useFixedBase=True)
    # self.obj_id = self.p.loadURDF( os.path.join(self.urdf_dir, "obj_libs/laptop/10211/mobility.urdf"),basePosition=self.obj_position,baseOrientation=self.obj_orientation,globalScaling=self.obj_scaling,useFixedBase=True)
    self.obj_id = self.p.loadURDF( os.path.join(self.urdf_dir, "obj_libs/laptop/10211/mobility.urdf"),basePosition=self.obj_position,baseOrientation=self.obj_orientation,globalScaling=self.obj_scaling,useFixedBase=False)
  ...
  def obj_reset(self):
    ...
    # self.obj_position = [0.44+0.038, -0.07+0.083, table_z+0.14]
    # self.obj_position[0] = 0.43
    # self.obj_scaling = 0.3 #/ 6.26 * 3.1
 
    # laptop
    self.obj_position = [0.43, -0.07+0.083, table_z+0]
    self.obj_scaling = 0.4
  ...
  def reset(self):
    ...
    # laptop
    self.p.resetJointState(self.obj_id,1,-0.8,0.0)
    ...
    self.robot.setJointValue([0] * 7,210)
    self.robot1.setJointValue([0] * 7,210)
