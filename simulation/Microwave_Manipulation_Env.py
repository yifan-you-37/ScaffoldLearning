...
class RobotEnv():
  ...
  def init_obj(self):
    ...
    # microwave
    self.obj_position = [0.8, 0, table_z+0.3]
    self.obj_scaling = 0.3
    self.obj_orientation = [0,0,0,1.0]
    ...
    self.obj_id = self.p.loadURDF( os.path.join(self.urdf_dir, "obj_libs/microwaves/yifan/mobility_space.urdf"),basePosition=self.obj_position,baseOrientation=self.obj_orientation,globalScaling=self.obj_scaling,useFixedBase=True)
